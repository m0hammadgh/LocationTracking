 ...
 * @since 07/07/2014
 */
public class Singleton implements LocationListener, NmeaListener, GpsStatus.Listener, OnNmeaMessageListener {
...
//	}
    ...
    public void notifyGPSDataChanged() {
        if (mLocationManager != null) {
            ...
            Intent broadcastIntent = new Intent(GpsInfoConstants.Broadcasts.BROADCAST_GPS_CHANGED.getString());
    ...
    public void notifyNetworkDataChanged() {
        if (mLocationManager != null) {
            ...
            // Broadcast that data has changed
            Intent broadcastIntent = new Intent(GpsInfoConstants.Broadcasts.BROADCAST_NETWORK_CHANGED.getString());
            mContext.sendBroadcast(broadcastIntent);
        }
    }
    ...
    public void notifyNetworkStateChanged() {
        if (mLocationManager != null) {
            ...
            // Broadcast that data has changed
            Intent broadcastIntent = new Intent(GpsInfoConstants.Broadcasts.BROADCAST_NETWORK_STATE_CHANGED.getString());
    ...
    public void notifyGPSStateChanged() {
        // Broadcast that data has changed
        Intent broadcastIntent = new Intent(GpsInfoConstants.Broadcasts.BROADCAST_GPS_STATE_CHANGED.getString());
        mContext.sendBroadcast(broadcastIntent);
    }
    ...
    public void notifyNMEAChanged() {
        // Broadcast that data has changed
        Intent broadcastIntent = new Intent(GpsInfoConstants.Broadcasts.BROADCAST_NMEA_CHANGED.getString());
        mContext.sendBroadcast(broadcastIntent);
    }
    ...
    public void notifyPassiveDataChanged() {
        if (mLocationManager != null) {
            ...
            // Broadcast that data has changed
            Intent broadcastIntent = new Intent(GpsInfoConstants.Broadcasts.BROADCAST_PASSIVE_CHANGED.getString());
            mContext.sendBroadcast(broadcastIntent);
        }
    }
