...
public class LocationData {
    ...
    public String getAccuracyAsString() {
        if (this.mLocation != null) {
            return mLocation.getAccuracy() + METRES + CONFIDENCE;
        } else {
    ...
    public String getAltitudeAsString() {
        if (this.mLocation != null) {
            return mLocation.getAltitude() + METRES;
        } else {
            return NOT_AVAILABLE;
        }
    }
    ...
    public String getBearingAsString() {
        if (this.mLocation != null) {
            return mLocation.getBearing() + DEGREES;
        } else {
            return NOT_AVAILABLE;
        }
    }
    ...
    public String getLatitudeAsString() {
        if (this.mLocation != null) {
            return mLocation.getLatitude() + DEGREES;
        } else {
            return NOT_AVAILABLE;
        }
    }
    ...
    public String getLongitudeAsString() {
        if (this.mLocation != null) {
            return mLocation.getLongitude() + DEGREES;
        } else {
            return NOT_AVAILABLE;
        }
    }
    ...
    public String getSpeedAsString() {
        if (this.mLocation != null) {
            return mLocation.getSpeed() + METERS_SECONDS;
        } else {
            return NOT_AVAILABLE;
        }
    }
    ...
    public String getTimeSinceLastFixAsString() {
        if (this.mLocation != null && getUtcFixTime() > 0) {
            return (getCurrentTime() - getUtcFixTime()) + MILLISECONDS;
        } else {
            return NOT_AVAILABLE;
        }
    }
    ...
    public String getUtcFixTimeAsString() {
        if (this.mLocation != null) {
            return mLocation.getTime() + MILLISECONDS;
        } else {
            return NOT_AVAILABLE;
        }
    }
